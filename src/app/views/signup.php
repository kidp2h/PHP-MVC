  ...
  <div id="form-signup">
    <div class="form-group">
      ...
      <div class="group-input">
        <input type="text" class="form-input status-valid" id="fullname" name="fullname" placeholder="Full Name" value=""/>
    ...
    <div class="form-group">
      ...
      <span class="validate-message">Error</span>
      <div class="group-input">
        <input type="email" class="form-input status-valid" value="" id="email" name="email" placeholder="Email" />
        <i class="fa-solid fa-circle-info"></i>
      </div>
    </div>
    <div class="form-group">
      ...
      <span class="validate-message">Error</span>
      <div class="group-input">
        <input type="text" class="form-input status-valid" value="" id="username" name="username" placeholder="Username" />
        <i class="fa-solid fa-circle-info"></i>
      </div>
    </div>
    <div class="form-col-2">
      <div class="form-group">
        ...
        <span class="validate-message">Error</span>
        <div class="group-input">
        <input type="password" class="form-input status-valid" value="" id="password" name="password" placeholder="Password" />
      ...
      <div class="form-group">
        ...
        <span class="validate-message">Error</span>
        <div class="group-input">
        <input type="password" class="form-input status-valid" value="" id="confirm-password" name="confirm-password" placeholder="Confirm password" />
          <!-- <i class="fa-solid fa-check"></i> -->
          <!-- <i class="fa-solid fa-eye showPassword"></i>
          <input type="checkbox" name="" id="" style="display: none;" checked> -->
        </div>
